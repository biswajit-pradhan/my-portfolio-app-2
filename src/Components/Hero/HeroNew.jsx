        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-center">
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            >
              ...
              <div className="flex items-center gap-3 text-gray-700 dark:text-gray-300">
                <span className="text-xl">🎨</span>
                <span>Beautiful UI/UX focus</span>
              </div>
              <div className="flex items-center gap-3 text-gray-700 dark:text-gray-300">
                <span className="text-xl">🚀</span>
          ...
          >
            <div className="relative group">
              {/* Moving bright light border effect */}
              <div
              ...
              {/* Floating badges */}
              <div
                className="absolute -top-6 -left-6 px-4 py-2 bg-indigo-600 text-white rounded-lg shadow-lg animate-bounce z-20"
                style={{ animationDelay: "0s" }}
              >
                <p className="text-sm font-semibold">React</p>
              </div>
              <div
                className="absolute -top-6 -right-6 px-4 py-2 bg-purple-600 text-white rounded-lg shadow-lg animate-bounce z-20"
                style={{ animationDelay: "0.2s" }}
              >
                <p className="text-sm font-semibold">Tailwind</p>
              </div>
              <div
                className="absolute top-1/2 -translate-y-1/2 -left-8 px-4 py-2 bg-pink-600 text-white rounded-lg shadow-lg animate-bounce z-20"
                style={{ animationDelay: "0.4s" }}
              >
                <p className="text-sm font-semibold">UI/UX</p>
              </div>
              <div
                className="absolute top-1/2 -translate-y-1/2 -right-8 px-4 py-2 bg-orange-600 text-white rounded-lg shadow-lg animate-bounce z-20"
                style={{ animationDelay: "0.6s" }}
              >
                <p className="text-sm font-semibold">Java</p>
              </div>
              <div
                className="absolute -bottom-6 -left-6 px-4 py-2 bg-red-600 text-white rounded-lg shadow-lg animate-bounce z-20"
                style={{ animationDelay: "0.8s" }}
              >
                <p className="text-sm font-semibold">Springboot</p>
              </div>
              <div
                className="absolute -bottom-6 left-1/2 -translate-x-1/2 px-4 py-2 bg-yellow-600 text-white rounded-lg shadow-lg animate-bounce z-20"
                style={{ animationDelay: "1s" }}
              >
                <p className="text-sm font-semibold">AWS</p>
              </div>
              <div
                className="absolute -bottom-6 -right-6 px-4 py-2 bg-cyan-600 text-white rounded-lg shadow-lg animate-bounce z-20"
             ...
             px-4 py-2 bg-teal-600 text-white rounded-lg shadow-lg
             animate-bounce z-20"
                style={{ animationDelay: "1.4s" }}
              >
                <p className="text-sm font-semibold">NoSQL</p>
              </div>
            </div>
          </div>
        </div>
